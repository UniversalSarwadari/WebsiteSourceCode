...
use Barn2\WBV_Lib\Admin\Settings_API_Helper;
use Barn2\WBV_Lib\Plugin\License\License;
...
class License_Key_Setting implements Registerable, License_Setting {
	...
	private function get_license_description() {
		$buttons = [
			'check'      => $this->license_action_button( self::CHECK_KEY, __( 'Check', 'woocommerce-bulk-variations' ) ),
